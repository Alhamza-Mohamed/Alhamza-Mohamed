...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:1a1a2e,100:16213e&height=200&section=header&text=Alhamza%20Mohamed&fontSize=50&fontColor=58a6ff&fontAlignY=40&desc=ML%20Engineer%20%7C%20NLP%20%7C%20LLM%20Specialist&descColor=8b949e&descAlignY=60&animation=fadeIn" />

[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono\&size=18\&pause=1000\&color=58A6FF\&center=true\&vCenter=true\&width=600\&lines=Building+intelligent+NLP+systems+%F0%9F%A7%A0;Fine-tuning+LLMs+for+real-world+tasks+%F0%9F%A4%96;Transforming+raw+text+into+actionable+insights+%F0%9F%93%8A;Exploring+AI+intersections+with+math+and+engineering+%F0%9F%94%96;Open+to+collaborate+on+AI+research+%26+products+%F0%9F%9A%80)](https://git.io/typing-svg)
...
```python
alhamza = {
    "role":       "ML Engineer & NLP/LLM Specialist",
    "focus":      ["Large Language Models", "NLP Pipelines", "Deep Learning"],
    "approach":   "Systems thinking + hands-on engineering",
    "interests":  ["LLM Fine-tuning", "RAG Systems", "Text Understanding", "AI-Physics-Engineering Integration"],
    "currently":  "Building production-grade AI systems that learn and reason over complex data",
    "contact":    "alhamza.mohamed64@gmail.com"
}
```
...
<div align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com?user=Alhamza-Mohamed&theme=dark&hide_border=true&background=0d1117&stroke=58a6ff&ring=58a6ff&fire=ff6b35&currStreakNum=ffffff&sideNums=58a6ff&currStreakLabel=58a6ff&sideLabels=8b949e&dates=8b949e&timezone=Africa/Cairo&cache_seconds=1800" alt="GitHub Streak" />
</div>
